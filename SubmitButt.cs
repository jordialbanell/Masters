...
public class SubmitButt : MonoBehaviour
{
  ...
  public void scenes(int scene)
  {
    ...
    if (scene == 1)
    {
      ...
      public void Pressed()
      {
        ...
        if (VocOnPlank == 1 && DrumOnPlank == 1 && PiOnPlank == 1 && GuiOnPlank == 1 && checking == 0)
        {
          print("all 4 are on");
          ...
          } else if (VocOnPlank == 1 && DrumOnPlank == 1 && PiOnPlank == 1 && GuiOnPlank == 1 && checking == 1)
          {
            print("all 4 are on");
            animator.SetBool("AllGood", true);
            videoPlayer.SetActive(true);
